...
# CONF-PERF-003: current-byte validation precedes inert historical comparison.
PERFORMANCE_AUTHORITY = "337d46d0dd1609ff875b88a558ac0ae7244858ff1c1b45e91829e362ea0fd85d"
...
def performance_proof(sources):
    ...
    performance_require(canonical(proof) == raw and proof["schemaVersion"] == "planeon.conformance-performance-delta/v3"
